  ...
  return (
    <div className="mt-8 border-t pt-6">
      ...
      <form onSubmit={handleSubmit} className="mt-4 flex gap-2 items-center">
        {isRecording ? (
            <div className="flex-grow flex items-center justify-between p-3 border rounded-lg bg-slate-100">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="p-2 text-slate-500 hover:text-slate-700 rounded-full hover:bg-slate-200 transition-colors"
